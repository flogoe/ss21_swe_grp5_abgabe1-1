...
export const testdaten: FilmData[] = [
    {
        ...
        beschreibung:
            'Afrikas gigantische Landschaften sind atemberaubend in ihrer einmaligen Schönheit und faszinieren mit ihrer Vielfalt an Tieren, die oft einen Kampf um Leben und Tod führen. Zu den faszinierendsten Landschaften zählt das Okavango-Delta in Botsuana.',
    ...
    },
    {
        ...
        beschreibung:
            'Er ist der größte Hafen Deutschlands, aber nicht allein das macht den Hamburger Hafen so außergewöhnlich: Er ist auch der einzige große Seehafen, der mitten in einer Großstadt liegt. Den Seefahrern bereitet genau das aber auch Sorgen. Seine Lage macht ihn nicht gerade zum günstigsten Anlaufpunkt für moderne Containerriesen, die Waren aus aller Welt bringen. Unsere Dokumentation zeigt den Hamburger Hafen von allen Seiten und begleitet den Arbeitsalltag zwischen Hafenbecken, Kaianlagen und Containern.',
    ...
    },
    {
        ...
        beschreibung:
            'Anlaesslich ihres 90. Geburtstages laedt Miss Sophie zum Geburtstagsdinner. Schluepft nach - einander in die Rolle des Butlers James und spielt Szenen aus dem beruehmten TV-Klassiker nach. Serviert Speis und Trank, sprecht einen Toast auf Miss Sophie aus – und vergesst nicht ueber den Tigerkopf zu stolpern!',
